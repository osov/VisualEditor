...
import { socketBoolean, socketNumber } from '../../sockets'


export class BoolMathNode extends Classic.Node<{ A: Classic.Socket; B: Classic.Socket }, { val: Classic.Socket }>
{
    width = 180;
    height = 140;
    ...
    constructor(node_name: string, node_title: string, initial?: { A?: number; B?: number }) {
        ...
        this.addOutput("val", new Classic.Output(socketBoolean, "Результат"));
    }
